...
namespace PingPong
{
    ...
    class Program : GameWindow
    {
        ...
        static Retangulo criaRetangulo(int x, int y, int largura, int altura)
        {
        ...
        static void Main()
        {
            ...
            p.bola = criaRetangulo(0, 0, 20, 20);

            int larguraDosJogadores = p.bola.largura;
            int alturaDosJogadores = p.bola.altura * 3;

            p.jogador1 = criaRetangulo(-p.ClientSize.Width / 2 + larguraDosJogadores / 2, 0, larguraDosJogadores, alturaDosJogadores);

            p.jogador2 = criaRetangulo(p.ClientSize.Width / 2 - larguraDosJogadores / 2, 0, larguraDosJogadores, alturaDosJogadores);
